...
async function bootstrap() {
  ...
  const proxyConfigItems = new Map([
    ...
    [
      'subscriptions',
      configService.getOrThrow<string>('SUBSCRIPTIONS_SVC_ORIGIN'),
    ],
    ['users', configService.getOrThrow<string>('USERS_SVC_ORIGIN')],
    [
      'video-manager',
      configService.getOrThrow<string>('VIDEO_MANAGER_SVC_ORIGIN'),
    ],
    [
      'video-processor',
      configService.getOrThrow<string>('VIDEO_PROCESSOR_SVC_ORIGIN'),
    ],
